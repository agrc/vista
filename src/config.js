...
const config = {
  ...
  urls: {
    ...
    PARCELS:
      "http://tiles.arcgis.com/tiles/99lidPhWCzftIe9K/arcgis/rest/services/StatewideParcels/VectorTileServer",
    SANPETE_ADDRESS_GRID:
      "https://services8.arcgis.com/4HViMZMD64noZWcJ/ArcGIS/rest/services/Sanpete_Addrss_Grid/FeatureServer/1",
  },
  featureClassNames: {
